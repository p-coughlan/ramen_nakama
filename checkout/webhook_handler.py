...
# Import the Stripe library at the top of the webhook_handler.py file: import stripe
# Update the payment_intent_succeeded method within the StripeWH_Handler class in webhook_handler.py:
#           	  
# ...
